...
import { updateAkScore } from '../services/firebasedb';
import Ionicons from '@expo/vector-icons/Ionicons';


const AkDetailsScreen = ({ route, navigation }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.title2}>Created By: {Competition.creator}</Text>
...
export default AkDetailsScreen
